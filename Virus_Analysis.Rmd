...
ourfinaldata %>% filter(Country_Region == "United Kingdom") %>% group_by(Date) %>%  ggplot() + geom_line(aes(x = Date, y = Confirmed,group =1), linetype = "dashed")  + geom_line(aes(x = Date, y = Deaths,group =1), color = "red")+ ggtitle("United Kingdom Cases and Deaths")
...
states = virus %>% filter(Country_Region == "United States",Province_State == "New York"|Province_State == "California"|Province_State == "Washington"|Province_State == "Pennsylvania")

ggplot(states,aes(x = Date,y = Confirmed, group = Province_State))+geom_line(aes(color = Province_State))

virus %>% filter(Country_Region == "United States",Province_State == "New York")
ourfinaldata %>% filter(Country_Region == "China")
```
